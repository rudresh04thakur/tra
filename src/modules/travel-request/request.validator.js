...
module.exports = {
  ...
  validateApprove: (httpRequest) => {
    const schema = Joi.object({
      ...
      airfareTrainAmount: Joi.string().allow(null, ''),
      airfareTrainDays: Joi.string().allow(null, ''),
      airfareTrainTotal: Joi.string().allow(null, ''),
      lodgingAmount: Joi.string().allow(null, ''),
      lodgingDays: Joi.string().allow(null, ''),
      lodgingTotal: Joi.string().allow(null, ''),
      mieAmount: Joi.string().allow(null, ''),
      mieDays: Joi.string().allow(null, ''),
      mieTotal: Joi.string().allow(null, ''),
      conferenceAmount: Joi.string().allow(null, ''),
      conferenceDays: Joi.string().allow(null, ''),
      conferenceTotal: Joi.string().allow(null, ''),
      automobileRentalAmount: Joi.string().allow(null, ''),
      automobileRentalDays: Joi.string().allow(null, ''),
      automobileRentalTotal: Joi.string().allow(null, ''),
      allTravelTotal: Joi.string().allow(null, ''),
      milageAmount: Joi.string().allow(null, ''),
      milageDays: Joi.string().allow(null, ''),
      milageTotal:  Joi.string().allow(null, '')
    });
    return schema.validate(httpRequest.body, options);
  },
